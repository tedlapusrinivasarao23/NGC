                    ...
                    <div class="s-header__navbar-row">
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                ...
                                <a href="index.html" class="s-header__logo-img s-header__logo-img-default">NEAR GEO CNTACTS</a>
                                <a href="index.html" class="s-header__logo-img s-header__logo-img-shrink">NEAR GEO CNTACTS</a>
                ...
                <div class="row g-row-col--5 g-margin-b-80--xs">
                    ...
                    <div class="col-xs-4 g-full-width--xs g-margin-b-50--xs g-margin-b-0--sm">
                        <div class="g-text-center--xs">
                            ...
                            <p class="g-color--white-opacity">Rainbow Vistas
Rock Garden, Phase -II, Green Hills Road
Opp. to IDL Factory, Kukatpally, Hyderabad, TS 500018</p>
                        </div>
                    </div>
