...
<!--<![endif]-->
	...
	<body>
		...
		<div id="wrapper">
			...
			<div class="content-block" id="adminLogin">
				<div class="container text-center">
					<header class="block-heading cleafix">
						<h1>Admin Login</h1>
					</header>
					<section class="block-body">
						<div class="row">
							<div class="col-md-6 col-md-offset-3">
							<form:form action="${pageContext.request.contextPath}/ngc/welcomeAdmin.htm" method="post" modelAttribute="login" class="" role="form">
									<div class="form-group">
								    	<form:input path="userName" class="form-control form-control-white" placeholder="Your Name" required/>
								  	</div>
								    <div class="form-group">
								    <form:password path="password" class="form-control form-control-white" placeholder="password" required/>
								    
								    </div>
								   
								  <form:button class="btn btn-o-white" value="Submit">Submit</form:button>
								</form:form>
							</div>
						</div>
					</section>
